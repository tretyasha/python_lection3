...
# если никакой аргумент не передаем нашей функции,то берется по умолчанию,если передаем то переменная будет иметь значения того аргумента которого передали